...
impl SkillManager {
    ...
    pub fn generate_prompt_context(&self) -> String {
        ...
        if enabled_skills.is_empty() {
            ...
            context.push_str("- Install: `/skill install <skill-name>` or `eiva clawhub install <skill-name>`\n\n");
        ...
        context.push_str("To install a skill: `/skill install <skill-name>` or `eiva clawhub install <skill-name>`\n\n");
