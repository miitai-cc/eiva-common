...
fn ws() -> &'static Path {
    // In the workspace, CARGO_MANIFEST_DIR is crates/eiva-claw-core.
...
fn test_list_directory() {
    let args = json!({ "path": "crates/eiva-claw-core/src" });
...
fn test_search_files_finds_pattern() {
    let args = json!({ "pattern": "exec_read_file", "path": "crates/eiva-claw-core/src", "include": "*.rs" });
