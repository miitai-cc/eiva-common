...
impl SecretsManager {
    ...
    pub(super) const TOTP_SECRET_KEY: &'static str = "__eiva_totp_secret";
    ...
    pub fn setup_totp(&mut self, account_name: &str) -> Result<String> {
        self.setup_totp_with_issuer(account_name, "Eiva")
    }
    ...
    const BROWSER_STORE_KEY: &'static str = "__eiva_browser_store";
