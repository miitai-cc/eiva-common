...
fn default_remote_workdir() -> String {
    "/tmp/eiva-workspace".to_string()
}

fn default_remote_storage() -> String {
    "/tmp/eiva-storage".to_string()
}
...
mod tests {
    ...
    fn default_config_values() {
        ...
        assert_eq!(config.remote_workdir, "/tmp/eiva-workspace");
        assert_eq!(config.remote_storage, "/tmp/eiva-storage");
