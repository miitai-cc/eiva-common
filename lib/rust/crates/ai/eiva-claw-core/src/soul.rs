...
mod tests {
    ...
    fn test_soul_manager_creation() {
        let temp_path = std::env::temp_dir().join("eiva_test_soul.md");
    ...
    fn test_needs_hatching_no_file() {
        let temp_path = std::env::temp_dir().join("eiva_test_soul_nonexistent.md");
    ...
    fn test_needs_hatching_default_content() {
        let temp_path = std::env::temp_dir().join("eiva_test_soul_default.md");
    ...
    fn test_needs_hatching_custom_content() {
        let temp_path = std::env::temp_dir().join("eiva_test_soul_custom.md");
