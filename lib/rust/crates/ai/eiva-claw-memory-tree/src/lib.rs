...
//! # Scope
//!
//! eiva-claw-memory-tree handles **external data ingest**: emails, scrapes, ingested
...
//! `steel_memory` integration in `eiva-claw-core`.
//!
...
//! be wired alongside eiva-claw-memory-tree as a secondary index over the same chunks.
//!
//! # Pipeline
//!
